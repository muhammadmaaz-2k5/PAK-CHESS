...
export function PlayCard() {
  ...
  const gameModeData = [
    ...
    },
    {
      ...
      title: 'Play Computer',
      description: 'Challenge an AI bot at various skill levels',
      disabled: true,
    },
    {
      icon: (
    ...
    },
    {
      ...
      description: '960, King of the Hill, Crazyhouse and more',
      disabled: true,
    },
  ];
    ...
    <Card className="bg-transparent border-none shadow-none w-full max-w-md">
      <CardHeader className="pb-4 text-center">
        <CardTitle className="font-bold tracking-tight flex flex-col items-center justify-center">
          ...
          <img className="w-24 mt-4 drop-shadow-lg" src="/chess.png" alt="chess" />
        </CardTitle>
      </CardHeader>
